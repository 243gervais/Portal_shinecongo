...
from comptes.views import (
    ...
    admin_fuel_purchases,
    admin_edit_fuel_purchase,
    ...
    admin_company_secret_documents,
    admin_upload_company_secret_document,
    admin_download_company_secret_document,
    admin_edit_company_secret_document,
    admin_delete_company_secret_document,
    admin_meeting_notes,
    admin_meeting_note_form,
    admin_meeting_note_pdf,
    admin_delete_meeting_note,
...
urlpatterns = [
    ...
    path("admin-dashboard/fuel-purchases/", admin_fuel_purchases, name="admin_fuel_purchases"),
    path("admin-dashboard/water-purchases/<int:purchase_id>/edit/", admin_edit_water_purchase, name="admin_edit_water_purchase"),
    path("admin-dashboard/fuel-purchases/<int:purchase_id>/edit/", admin_edit_fuel_purchase, name="admin_edit_fuel_purchase"),
    ...
    path("admin-dashboard/fuel-purchases/<int:purchase_id>/delete/", admin_delete_fuel_purchase, name="admin_delete_fuel_purchase"),
    ...
    path("admin-dashboard/company-secrets/", admin_company_secret_documents, name="admin_company_secret_documents"),
    path("admin-dashboard/company-secrets/upload/", admin_upload_company_secret_document, name="admin_upload_company_secret_document"),
    path("admin-dashboard/company-secrets/<int:document_id>/download/", admin_download_company_secret_document, name="admin_download_company_secret_document"),
    path("admin-dashboard/company-secrets/<int:document_id>/edit/", admin_edit_company_secret_document, name="admin_edit_company_secret_document"),
    path("admin-dashboard/company-secrets/<int:document_id>/delete/", admin_delete_company_secret_document, name="admin_delete_company_secret_document"),
    path("admin-dashboard/meeting-notes/", admin_meeting_notes, name="admin_meeting_notes"),
    path("admin-dashboard/meeting-notes/new/", admin_meeting_note_form, name="admin_create_meeting_note"),
    path("admin-dashboard/meeting-notes/<int:note_id>/edit/", admin_meeting_note_form, name="admin_edit_meeting_note"),
    path("admin-dashboard/meeting-notes/<int:note_id>/pdf/", admin_meeting_note_pdf, name="admin_meeting_note_pdf"),
    path("admin-dashboard/meeting-notes/<int:note_id>/delete/", admin_delete_meeting_note, name="admin_delete_meeting_note"),
    ...
    path("admin-dashboard/site/<uuid:site_id>/pointages/<int:pointage_id>/items/<slug:target>/delete/", admin_delete_pointage_item, name="admin_delete_pointage_item"),
    ...
    path("admin-dashboard/site/<uuid:site_id>/attendance-photos/", admin_site_attendance_photos, name="admin_site_attendance_photos"),
